...
# Run K times.
    ...
    for i in range(0,K):
        ...
        modelNB1.add(layers.Conv2D(128, (3, 3), activation='sigmoid', input_shape=(28, 28,1)))
        ...
        modelNB3.add(layers.Conv2D(64, (3, 3), activation='sigmoid', input_shape=(28, 28,1)))
        modelNB3.add(layers.MaxPooling2D((2, 2)))
        modelNB3.add(layers.Conv2D(32, (3, 3), activation='sigmoid', input_shape=(28, 28,1)))
        modelNB3.add(layers.MaxPooling2D((2, 2)))
        ...
        model.compile(optimizer=opt,
                ...
                metrics=['accuracy'])
        history=None
        history = model.fit(train_images, train_labels, epochs=60, validation_split=test_pct/(train_pct+valid_pct),batch_size=32)
...
def optimize_learning_rate():
    learning_rate_range = np.logspace(-6,-3,5)
